...
class MontaraGalSimRunner(Step):
    ...
    def update_stash(self, config, stash):
        ...
        stash["input_pizza_cutter_yaml"] = {}
        stash["input_pizza_cutter_yaml"][tilename] = {}
        for band in bands:
            # read band information for the tile
            stash["input_pizza_cutter_yaml"][tilename][band] = read_pizza_cutter_yaml(
